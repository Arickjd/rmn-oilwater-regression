...
def build_parser():
    ...
    parser.add_argument("--test-size", type=int, default=175, help="Número de amostras reservadas para teste.")
...
def run_pipeline(args):
    ...
    cv = None
    if args.cv_folds:
        # A CV recebe somente o desenvolvimento; o teste final fica intocado.
    ...
    config.update(selected_model_by_cv=cv.selected_model if cv is not None else None,
                  split_unit="row", baseline_train_mean=baseline)
